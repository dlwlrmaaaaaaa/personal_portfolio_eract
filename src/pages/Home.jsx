...
const Home = () => {
  return (
   <>
     <div className='lg:h-[90vh] flex flex-col items-center gap-5 py-20 bg-secondary'>
         ...
         <div className='flex items-center flex-col gap-4'>
            ...
            <button className='text-xs lg:text-lg flex items-center bg-primary lg:px-4 lg:py-2 rounded-md font-poppins gap-2 px-3 py-1 font-semibold'><a href="#projects">Explore Portolio</a> <FaArrowDown/></button>       
        </div>
     </div>
     <div className="w-full overflow-hidden  mt-10 h-20 lg:h-40">
